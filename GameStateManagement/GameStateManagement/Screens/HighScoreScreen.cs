...
namespace GameStateManagement
{
    class HighScoreScreen : GameScreen
    {
        ...
        {
            Storage.BeginOpenContainer(GameStateManagement.Game1.GameName, SaveContainerOpened, null);
        }
    ...
    HighscoreLoaded = true;
        ...
        {
            Storage.BeginOpenContainer(GameStateManagement.Game1.GameName, LoadContainerOpened, null);
        }
